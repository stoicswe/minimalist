...
public enum DocumentKindDetector {
    ...
    public static let textLoadCeiling: Int64 = 50 * 1024 * 1024
    ...
    public static func mediaKind(forExtension ext: String) -> DocumentKind? {
    ...
    public static func isAsciiDoc(_ url: URL) -> Bool {
    ...
    public static func supportsReaderView(_ url: URL) -> Bool {
